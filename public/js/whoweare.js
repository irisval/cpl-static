...
$(document).ready(function(){
  $('.whoweare-current').trigger('click');
});

$('.whoweare-current').on('click', function() {
 ...
 for (let person of people) {
  if (person.type !== 'alum') {
    ...
    whowearebody += '<div class="column is-one-third-desktop is-one-third-tablet">';
    if (person.type == 'student') {
     whowearebody += '<div class="card card-student">'
   } else {
   ...
   whowearebody += '</p><p class="tag">'
   if (person.type == 'student') {
     whowearebody += 'Grad Student'
   } else {
     whowearebody += person.tag;
   }
   whowearebody += '</p><div class="card-content__bottom"><a class="email" href="mailto:">'
   whowearebody += person.email;
   whowearebody += '</a><p class="loc">'
   whowearebody += person.location;
   whowearebody += '</p></div></div></div></div>';
...
for (let i = 0; i <  3 - (added % 3); i++) {
  whowearebody += '<div class="column></div>'
  if (i == 3 - (added % 3) - 1) {
   whowearebody += '</div>';
 }
}

$('.whoweare-all .section-inner').append(whowearebody);
});

$('.whoweare-students').on('click', function() {
  $(".is-active").removeClass("is-active");
  $(this).parent("li").addClass("is-active");
  $('.whoweare-all .section-inner').empty();
  ...
  for (let person of people) {
    if (person.type === 'student') {
      ...
      whowearebody += '" alt=""></figure></div><div class="card-content"><p class="name">'
      whowearebody += person.name;
      whowearebody += '</p><p class="tag">Grad Student</p><div class="card-content__bottom"><a class="email" href="mailto:">'
      whowearebody += person.email;
      whowearebody += '</a><p class="loc">'
      whowearebody += person.location;
      whowearebody += '</p></div></div></div></div>';
...
$('.whoweare-faculty').click(function() {
  $(".is-active").removeClass("is-active");
  $(this).parent("li").addClass("is-active");
  $('.whoweare-all .section-inner').empty();
  let whowearebody = '';
...
$('.whoweare-alumni').on('click', function() {
  ...
  for (let person of people) {2
    if (person.type === 'alum') {
      ...
      whowearebody += person.name;
      whowearebody += '</p><p class="tag">'
      whowearebody += person.year;
      whowearebody += '</p><div class="card-content__bottom"><p class="alum-position">'
      whowearebody += person.tag;
      whowearebody += '</p></div></div></div></div>';
